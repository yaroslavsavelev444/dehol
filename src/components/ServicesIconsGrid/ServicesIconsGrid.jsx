...
const services = [
  {
    ...
    description:
      "  Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempore tempora error enim dolorum numquam! Aspernatur dolor quidem magnam molestiae deleniti.  Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempore tempora error enim dolorum numquam! Aspernatur dolor quidem magnam molestiae deleniti.",
      ...
      <div className="services-container">
        ...
        <div className="details-panel" key={activeIndex}>
          ...
          <div className="details-description">
            <p className="fade-item fade-text">
