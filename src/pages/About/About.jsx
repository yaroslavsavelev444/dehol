...
const LazyTextImageBlock = lazy(() => import('../../components/TextImageBlocks/TextImageBlock'));
const LazyMosaicGrid = lazy(() => import('../../components/ImageGrid/MosaicGrid'));
const LazyUniformGrid = lazy(() => import('../../components/UniformGrid/UniformGrid'));
const LazyImageGallery = lazy(() => import('../../components/ImageLightBoxGallery/ImageGallery'));
const LazyCitiesSlider = lazy(() => import('../../components/WordCarousel/WordCarousel'));
...
export default function About() {
  ...
  <LazyTextImageBlock
    ...
    subtitle={"Lorem ipsum dolor sit amet consectetur adipisicing elit. Quis, pariatur."}
